...
class AdjListsGraphTest {
    ...
    void parsingTest() throws Exception {
        ...
        g.addSubgraphFromFile(
                Paths.get(AdjListsGraphTest.class.getResource("/test_graph").toURI()),
                new SimpleGraphParser(),
                str -> str);

        Graph<String> expected = new AdjListsGraph<String>();
        ...
        Graph<String> g2 = new AdjListsGraph<String>();
