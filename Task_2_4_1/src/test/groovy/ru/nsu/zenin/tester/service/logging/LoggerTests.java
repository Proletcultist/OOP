package ru.nsu.zenin.tester.service.logging;

import java.io.StringWriter;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;
import ru.nsu.zenin.tester.service.logging.exception.IllegalLoggerStateException;
...
class LoggerTests {
    ...
    @Test
    void loggerTryLogTest() {
        StringWriter writer = new StringWriter();
        Logger.init(writer);

        Logger.tryLog(Logger.LogLevel.INFO, "aaaa");
